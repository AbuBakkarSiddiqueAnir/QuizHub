...
<head>
    <title>Code coverage report for mongoose-serial/lib/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">mongoose-serial/lib</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >exports.plugin = exports.extractCounter = exports.addZeros = exports.InitCounter = void 0;</span>
var mongoose = <span class="cstat-no" title="statement not covered" >require("mongoose");</span>
/**
 *
 */
var InitCounter;
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >fu</span>nction (InitCounter) {</span>
<span class="cstat-no" title="statement not covered" >    InitCounter["YEARLY"] = "yearly";</span>
<span class="cstat-no" title="statement not covered" >    InitCounter["MONTHLY"] = "monthly";</span>
<span class="cstat-no" title="statement not covered" >    InitCounter["DAILY"] = "daily";</span>
<span class="cstat-no" title="statement not covered" >    InitCounter["HOURLY"] = "hourly";</span>
 ...
 * @param size
 */
var addZeros = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (counter, size) {</span>
    var counterString = <span class="cstat-no" title="statement not covered" >counter.toString();</span>
<span class="cstat-no" title="statement not covered" >    while (counterString.length &lt; size)</span>
<span class="cstat-no" title="statement not covered" >        counterString = "0" + counterString;</span>
<span class="cstat-no" title="statement not covered" >    return counterString;</span>
};
<span class="cstat-no" title="statement not covered" >exports.addZeros = addZeros;</span>
/**
 *
 * @param options
 * @param serial
 */
var extractCounter = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (options, serial) {</span>
    var prefix = <span class="cstat-no" title="statement not covered" >options.prefix,</span> separator = <span class="cstat-no" title="statement not covered" >options.separator,</span> initCounter = <span class="cstat-no" title="statement not covered" >options.initCounter,</span> digits = <span class="cstat-no" title="statement not covered" >options.digits;</span>
    var counter;
<span class="cstat-no" title="statement not covered" >    if (serial !== null) {</span>
<span class="cstat-no" title="statement not covered" >        counter = serial.split(separator).slice(-1).join(separator);</span>
        var chunks = <span class="cstat-no" title="statement not covered" >serial.split(separator);</span>
<span class="cstat-no" title="statement not covered" >        switch (initCounter) {</span>
            case InitCounter.YEARLY:
                var currentYear = <span class="cstat-no" title="statement not covered" >new Date().getFullYear().toString();</span>
                var year = <span class="cstat-no" title="statement not covered" >chunks[chunks.length - 2];</span>
<span class="cstat-no" title="statement not covered" >                if (currentYear !== year)</span>
<span class="cstat-no" title="statement not covered" >                    return exports.addZeros(1, digits);</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
            case InitCounter.MONTHLY:
                var currentMonth = <span class="cstat-no" title="statement not covered" >exports.addZeros(new Date().getMonth() + 1, 2);</span>
                var month = <span class="cstat-no" title="statement not covered" >chunks[chunks.length - 2];</span>
<span class="cstat-no" title="statement not covered" >                if (currentMonth !== month)</span>
<span class="cstat-no" title="statement not covered" >                    return exports.addZeros(1, digits);</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
            case InitCounter.DAILY:
                var currentDay = <span class="cstat-no" title="statement not covered" >exports.addZeros(new Date().getDate(), 2);</span>
                var day = <span class="cstat-no" title="statement not covered" >chunks[chunks.length - 2];</span>
<span class="cstat-no" title="statement not covered" >                if (currentDay !== day)</span>
<span class="cstat-no" title="statement not covered" >                    return exports.addZeros(1, digits);</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
        }
<span class="cstat-no" title="statement not covered" >        return exports.addZeros(parseInt(counter) + 1, digits);</span>
    }
    else
<span class="cstat-no" title="statement not covered" >        return exports.addZeros(1, digits);</span>
};
<span class="cstat-no" title="statement not covered" >exports.extractCounter = extractCounter;</span>
/**
 *
 * @param schema
 * @param options
 */
var plugin = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (schema, options) {</span>
    var field = <span class="cstat-no" title="statement not covered" >options.field,</span> prefix = <span class="cstat-no" title="statement not covered" >options.prefix,</span> separator = <span class="cstat-no" title="statement not covered" >options.separator,</span> initCounter = <span class="cstat-no" title="statement not covered" >options.initCounter;</span>
    var counter;
<span class="cstat-no" title="statement not covered" >    schema.pre("save", <span class="fstat-no" title="function not covered" >fu</span>nction (next) {</span>
<span class="cstat-no" title="statement not covered" >        return __awaiter(this, void 0, void 0, <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
            var doc, lastDoc, serial, dating, t;
            var _a;
...
<span class="cstat-no" title="statement not covered" >                switch (_b.label) {</span>
                    case 0:
<span class="cstat-no" title="statement not covered" >                        doc = this;</span>
                        // feild must a string
<span class="cstat-no" title="statement not covered" >                        if (!(schema.path(field) instanceof mongoose.Schema.Types.String)) {</span>
<span class="cstat-no" title="statement not covered" >                            next(Error("Field must be type of string"));</span>
                        }
<span class="cstat-no" title="statement not covered" >                        return [4 /*yield*/, this.constructor.findOne({}).sort((_a = {}, _a["" + field] = -1, _a))];</span>
                    case 1:
<span class="cstat-no" title="statement not covered" >                        lastDoc = _b.sent();</span>
<span class="cstat-no" title="statement not covered" >                        serial = lastDoc ? lastDoc[field] : null;</span>
<span class="cstat-no" title="statement not covered" >                        counter = exports.extractCounter(options, serial);</span>
<span class="cstat-no" title="statement not covered" >                        switch (initCounter) {</span>
                            case InitCounter.YEARLY:
<span class="cstat-no" title="statement not covered" >                                dating = new Date().getFullYear().toString();</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
                            case InitCounter.MONTHLY:
<span class="cstat-no" title="statement not covered" >                                dating = [new Date().getFullYear().toString(), exports.addZeros(new Date().getMonth() + 1, 2)].join(separator);</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
                            case InitCounter.DAILY:
<span class="cstat-no" title="statement not covered" >                                dating = [new Date().getFullYear().toString(), exports.addZeros(new Date().getMonth() + 1, 2), exports.addZeros(new Date().getDate(), 2)].join(separator);</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        t = [];</span>
<span class="cstat-no" title="statement not covered" >                        if (prefix)</span>
<span class="cstat-no" title="statement not covered" >                            t.push(prefix);</span>
<span class="cstat-no" title="statement not covered" >                        if (dating)</span>
<span class="cstat-no" title="statement not covered" >                            t.push(dating);</span>
<span class="cstat-no" title="statement not covered" >                        t.push(counter);</span>
<span class="cstat-no" title="statement not covered" >                        doc[field] = t.join(separator);</span>
...
<span class="cstat-no" title="statement not covered" >exports.plugin = plugin;</span>
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Mar 08 2021 15:21:31 GMT+0100 (Central European Standard Time)
            </div>
        </div>
